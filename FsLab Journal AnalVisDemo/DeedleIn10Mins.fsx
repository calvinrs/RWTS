...
(**
Deedle in 10mins Demo
================

We are using FsLab, so that gets all the references for us
*)
...
(**
Finally, we can also load data frame from CSV: (TODO: find copies of these and add to the experement.)
*)
